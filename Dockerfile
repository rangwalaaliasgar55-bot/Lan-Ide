...
# tmux        → sesiones de terminal persistentes (lanide_<id>), el corazón del swarm
...
RUN git config --global user.name "LanIde Agent" \
    && git config --global user.email "agent@lanide.local" \
