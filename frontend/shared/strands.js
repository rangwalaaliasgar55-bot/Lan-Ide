// LAN_IDE — Strands: cintas de luz WebGL2 (port vanilla del <Strands/> de React Bits).
...
//
// Uso:  const h = LanIdeStrands.montar(container, { coloresCss: ['var(--ob-accent)', ...], speed: 0.3 });
...
(function (global) {
  ...
  global.LanIdeStrands = Object.assign(global.LanIdeStrands || {}, { _pure: pure });
...
`;
  ...
  Object.assign(global.LanIdeStrands, { montar, resolverColorCss });
