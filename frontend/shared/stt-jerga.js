// LAN_IDE — Post-corrección determinista del dictado (STT) + diagnóstico de mic.
//
...
(function (global) {
  ...
  const REGLAS = [
    ...
    regla('yarvis|yarbis|jarbis|harvis|iarvis|lanide', 'LanIde'),
  ...
  global.LanIdeSTT = Object.assign(global.LanIdeSTT || {}, {
