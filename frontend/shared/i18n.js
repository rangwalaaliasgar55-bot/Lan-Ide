/* ════════════════════════════════════════════════════════════════
   LanIde i18n — traductor de interfaz español ⇆ inglés.
   ...
   - Se respeta el contenido del USUARIO / dinámico: subárboles con
     ...
     intactos.
   - Persistencia: localStorage 'lanide.lang' (default 'en').
═══════════════════════════════════════════════════════════════ */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) module.exports = factory();
  else root.LanIdeI18n = factory();
  ...
  if (typeof document !== 'undefined') {
    var _lang = (function () {
      var v = null;
      try { v = localStorage.getItem('lanide.lang'); } catch (e) {}
    ...
    function setLang(lang) {
      ...
      _lang = lang;
      try { localStorage.setItem('lanide.lang', lang); } catch (e) {}
      document.documentElement.setAttribute('lang', lang);
      aplicar(document.body);
      try { window.dispatchEvent(new CustomEvent('lanide:lang', { detail: { lang: lang } })); } catch (e) {}
    }
    ...
    // El IIFE externo asigna root.LanIdeI18n = factory(); acá solo retornamos
