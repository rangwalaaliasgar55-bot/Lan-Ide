// LAN_IDE — Reporter de sección para la Rich Presence de Discord ("Jugando LanIde").
//
// El lanzador LanIde.exe (scripts/lanide-shell.cs, C#/WebView2 en Windows) es
...
(function (global) {
  ...
  // las pestañas del dock (panel.js: preview·lanide·editor·tasks·review·mobile).
  ...
  // el workspace abierto (browser + LanIde app, cada uno con su localStorage
  ...
  global.LanIdePresence = Object.assign(global.LanIdePresence || {}, { _pure: pure, ...pure });
  ...
  if (typeof document !== 'undefined' && typeof window !== 'undefined') {
    function _snapshot() {
      ...
      const D = window.LanIdeDock, S = window.LanIdeSettings;
      return {
        hayProyecto,
    ...
    function _localeActual() {
      try {
        return (window.LanIdeI18n && window.LanIdeI18n.lang && window.LanIdeI18n.lang() === 'en')
          ? 'en' : 'es';
      } catch (e) { return 'es'; }
    }
    ...
    function init() {
      ...
      window.addEventListener('lanide:lang', function () { reportar(true); });
    ...
    Object.assign(global.LanIdePresence, { init, reportar });
