// LAN_IDE — Notificaciones cuando un agente termina y la pestaña está en
...
(function (global) {
  ...
  global.LanIdeNotify = Object.assign(global.LanIdeNotify || {}, { _pure: pure });
  ...
  function _osOptIn() { return localStorage.getItem('lanide.notif.os') === '1'; }
  ...
  global.LanIdeNotify.avisar = ({ tipo, nombre, sonidoOn } = {}) => {
    ...
    if (debeOsNotif({ permiso, osOptIn: _osOptIn() })) {
      try {
        ...
        const n = new Notification('LanIde', { body: cuerpo, tag: 'lanide-agente' });
  ...
  global.LanIdeNotify.pedirPermiso = async () => {
