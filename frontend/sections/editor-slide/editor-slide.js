/* ═══════════════════════════════════════════════════════════════════════
   window.LanIdeSlideEditor — editor deslizante (visor de código)
...
(function (global) {
  ...
  const _z = () => (global.LanIdeEscala && global.LanIdeEscala.zoom) ? global.LanIdeEscala.zoom() : 1;
  ...
  function cerrar() {
    ...
    try { global.LanIdeStripFiles?.colapsar?.(); } catch (_) {}   // al salir del editor, el árbol de la franja se esconde de nuevo
  ...
  global.LanIdeSlideEditor = { abrirArchivo, cerrar, toggle, onProjectChanged, isOpen, isDirty, cerrarArchivo };
})(window);
