// LAN_IDE — Picker de terminal rápida (Ctrl+\): "Nueva terminal".
...
(function (global) {
  ...
  if (typeof document !== 'undefined') {
    ...
    const _L = (es, en) => (window.LanIdeI18n?.lang?.() === 'en' ? en : es);
    ...
    function _sumar(tipo, delta) {
      ...
      // abrir — el cacheo en LanIdeClisEstado lo carga al arrancar la página).
    ...
    function _build() {
      ...
      window.addEventListener('lanide:lang', () => { if (_el && !_el.hidden) _render(); });
    }
    ...
    function abrir({ proyecto, onPick, disponibles, existentes } = {}) {
      ...
      _clisEstado = Array.isArray(global.LanIdeClisEstado?.clis) ? global.LanIdeClisEstado.clis : null;
