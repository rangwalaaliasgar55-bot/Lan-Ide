// LAN_IDE — TerminalLayout: mosaico de terminales que SIEMPRE llena el espacio.
...
// el navegador. Espeja el patrón window.LanIdeEditor.
(function (global) {
  'use strict';
  ...
  const _zoomApp = () => (global.LanIdeEscala && global.LanIdeEscala.zoom) ? global.LanIdeEscala.zoom() : 1;
  ...
  if (typeof document !== 'undefined') {
    ...
    function _persistKey() { return `lanide.terminals.layout.${_projectId}`; }
