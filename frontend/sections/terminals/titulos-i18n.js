...
(function (global) {
  ...
  // en el browser los defaults leen LanIdeI18n y fetch reales EN CADA LLAMADA
  // (lazy: el orden de carga de los <script> no importa).
  function crear(deps) {
    deps = deps || {};
    const _lang = deps.lang || (() => {
      try { return global.LanIdeI18n ? global.LanIdeI18n.lang() : 'es'; } catch (e) { return 'es'; }
    });
  ...
  global.LanIdeTitulosI18n = Object.assign(global.LanIdeTitulosI18n || {}, api);
