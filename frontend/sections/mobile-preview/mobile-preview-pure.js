...
(function (root, factory) {
  ...
  //   autoMostrar — toggle global lanide.autoMobilePreview (ON por default).
  ...
  // LanIde = el dashboard adentro del teléfono. El workspace deshace el escape
  // re-apuntando el iframe con esta URL. dsSrc = último src bueno del iframe
  // (relativo a LanIde); rutaApp = ruta que la app tenía al descargarse.
  ...
  function urlSamplerVuelta(dsSrc, rutaApp) {
    ...
    try {
      var u = new URL(dsSrc, 'http://lanide.invalid');
