...
//
// Expone window.LanIdeDevServers = { init, cargar, refrescar, open, close,
//   toggle, _pure }.
...
(function (root) {
  ...
  // propio LanIde → su ruta bajo /static ('wb-redesigns'), sin /index.html
  ...
  function _filaServer(s) {
    ...
    quien.textContent = s.propio ? 'LanIde' : (s.terminal_nombre || 'un agente');
    ...
    x.type = 'button';
    x.className = 'jw-ds-x';
    // Demo = página servida por el PROPIO LanIde: el ✕ solo la saca del menú,
  ...
  root.LanIdeDevServers = { init, cargar, refrescar, open, close, toggle, _pure };

  if (typeof module !== 'undefined' && module.exports) module.exports = root.LanIdeDevServers;
