// Barra de título de la APP (LanIde.exe, el shell de escritorio) — SOLO adentro.
//
// La ventana no tiene marco nativo (FormBorderStyle.None en scripts/lanide-shell.cs):
