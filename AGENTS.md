...
This block is generated by the app from your local swarm memory (`.lan-ide/memory/lecciones-del-enjambre.md`): it distills the mistakes and findings of *your own* agents in ≤20 short rules, and refreshes on every session. Don't edit between markers — write a `[leccion]` memory instead.
<!-- LAN_IDE_LECCIONES_END -->
