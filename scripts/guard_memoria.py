#!/usr/bin/env python3
"""
Gate de admisión de memorias (.lan-ide/memory/) — corre en el pre-commit.
...
def _reportar(items, origen):
    ...
    for path, es_nueva, src in items:
        ...
        for violacion in validar(slug, src, es_nueva):
            ...
            fallo = 1
    if fallo:
        print(f"  (contrato de .lan-ide/memory/ en {origen} — ver protocolo en "
