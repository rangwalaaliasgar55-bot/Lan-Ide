...
El 2026-07-03 LanIde se movió/borró a sí mismo: su propio repo quedó registrado
como "proyecto" y un PATCH .../rename (os.rename) y un DELETE /api/projects
(shutil.rmtree) sobre /home/user/lanide se llevaron el árbol entero. El fix es
...
def test_es_ruta_protegida():
    # La raíz del propio LanIde: intocable.
...
def test_prefijo_textual_no_confunde():
    # "/home/user/lanide-oss" NO debe contar como dentro de "/home/user/lanide":
