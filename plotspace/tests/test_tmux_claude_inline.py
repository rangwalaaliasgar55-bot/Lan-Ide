...
menos profundidad para claude. Escape hatch: LAN_IDE_CLAUDE_FULLSCREEN=off.
...
def test_crear_sesion_claude_fullscreen():
    ...
    os.environ.pop("LAN_IDE_CLAUDE_FULLSCREEN", None)
...
def test_crear_sesion_fullscreen_escape_hatch():
    """LAN_IDE_CLAUDE_FULLSCREEN=off deja a claude con su default (sin -e)."""
    os.environ["LAN_IDE_CLAUDE_FULLSCREEN"] = "off"
    try:
        ns = _new_session_argv()
