...
Flujo "Agregar cuenta nueva": LanIde abre una terminal de login del CLI; este
...
def _setup(monkeypatch):
    fresh_db()
    home = tempfile.mkdtemp(prefix="lanide_home_")
    snaps = tempfile.mkdtemp(prefix="lanide_snaps_")
