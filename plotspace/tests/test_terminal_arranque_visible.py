...
def test_claude_visible_shell_pelado_y_tipeo_corto():
    ...
    assert ['tmux', 'send-keys', '-t', 'lanide_999', '-l', '--', 'claude'] in sk, sk
    assert ['tmux', 'send-keys', '-t', 'lanide_999', 'Enter'] in sk, sk
...
def test_tipeo_espera_el_prompt_antes_de_mandar():
    ...
    assert ['tmux', 'send-keys', '-t', 'lanide_999', '-l', '--', 'claude'] in argvs
    assert ['tmux', 'send-keys', '-t', 'lanide_999', 'Enter'] in argvs
