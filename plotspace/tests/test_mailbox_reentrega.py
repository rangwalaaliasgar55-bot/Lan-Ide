...
`.lan-ide/MAILBOX.md` desde un offset desfasado y **re-registró ~108 líneas
...
def test_reconoce_tambien_los_que_quedaron_sin_destino():
    """Los 36 `@lanide` del historial son justamente los que más se repetían."""
    db.registrar_mensaje_mailbox(7, 'A', 'lanide', 'che', None, 'normal')
    assert db.mensaje_ya_registrado(7, 'A', 'lanide', 'che') is True
