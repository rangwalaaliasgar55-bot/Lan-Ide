...
La regla: el puerto 3000 es de Lan Ide — ningún agente puede
...
markers LAN_IDE_PUERTOS_* (mismo patrón idempotente que mailbox/memoria).
"""
import os
import sys
...
from plotspace.core.puertos import parse_pids_puerto, matar_puerto, PUERTO_LAN_IDE
...
def test_matar_puerto_nunca_lanide():
    r = matar_puerto(PUERTO_LAN_IDE)   # 3000
