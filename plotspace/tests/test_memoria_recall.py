...
def test_match_por_tags_y_titulo_en_la_tarea():
    with tempfile.TemporaryDirectory() as d:
        _mem(d, 'regla-de-puertos', 'El 3000 es de LanIde.', tags='puertos, dev-server',
             titulo='Regla de puertos: el 3000 es de LanIde')
...
def test_tarea_engine_inyecta_memorias():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        assert '.lan-ide/memory/gotcha-preview.md' in tarea
...
def test_planning_recibe_memoria_relevante_al_pedido():
    ...
    with tempfile.TemporaryDirectory() as d:
        _mem(d, 'regla-de-puertos', 'El 3000 es de LanIde; elegí un puerto libre '
...
def test_reviewer_recibe_union_de_archivos():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        assert '.lan-ide/memory/gotcha-voice.md' in tarea
