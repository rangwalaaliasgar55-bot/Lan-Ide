...
`terminals.py` mezclaba dos cosas distintas en las mismas funciones:
  ...
  1. QUÉ lanzar — lógica de producto: qué CLI corre en la terminal, con qué
     ...
     LanIde y no cambia nunca según el sistema operativo.
...
class TerminalBackend(ABC):
    ...
    Todo lo que LanIde necesita de una sesión viva. Lo que NO está acá a
    ...
    def sanear_sesion(self, nombre: str) -> None:
        ...
        a un reinicio de LanIde. Opcional."""
...
class TmuxBackend(TerminalBackend):
    ...
    def _target_exacto(self, terminal_id: int) -> str:
        ...
        match exacto, y matar una `lanide_1` ya muerta se llevaba puesta a
        `lanide_12` viva."""
    ...
    def sanear_sesion(self, nombre: str) -> None:
        ...
        sobrevivieron a un reinicio de LanIde: si el server tmux se reinició,
