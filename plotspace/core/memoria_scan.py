...
_MAX_DIRS = 8
_DIRS_IGNORADOS = {'.git', '.lan-ide', '.workspace', 'node_modules', 'venv',
...
def _cuerpo(info: dict) -> str:
    ...
    lineas.append("\nRecordá la regla de puertos del proyecto (el 3000 es de LanIde) "
...
def sembrar_scan(project_path: str, hoy: str = None) -> bool:
    ...
    mdir = os.path.join(project_path, '.lan-ide', 'memory')
