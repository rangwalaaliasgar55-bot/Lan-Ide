...
frontend la abre directo en el navegador. Según el CLI:
  - Claude: imprime la URL + un prompt «Paste code here». Tras autorizar, la IA
    le da un CÓDIGO al usuario; el usuario lo pega en LanIde y lo escribimos al
...
# (LanIde se la puede abrir con el wizard andando — botón del modal de alta) y el
