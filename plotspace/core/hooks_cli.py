...
para los dos eventos de herramientas:
  ...
  PostToolUse (Edit|Write|NotebookEdit) → registra la edición REAL en LanIde.
...
NOMBRE_SCRIPT = 'lanide_ops_hook.py'

# Timeout corto y explícito: si LanIde se cuelga, el agente sigue trabajando.
...
SCRIPT_SESSION = 'lanide_claude_hook.py'
