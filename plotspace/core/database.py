...
def init_db():
    ...
    # (Las tablas jai_* del viejo "LanIde AI" se quitaron junto con la feature;
    ...
    # rotativo (data/lanide.log, horizonte ~500 eventos) — acá persiste y se
    ...
    # Viven SOLO acá (data/lanide.db es local y gitignoreado): nunca en el repo.
